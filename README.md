# Blinkered dictionary: Arabic

The Arabic word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Arabic.

**313,501 of 656,979 candidates proved — 47.7%**, across 6 independent
families, 4 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Arabic, and why those
...
Candidates come from Blinkered's Arabic list, which lives in
[`blinkered-attestation/candidates/ar`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/ar).
...
| **The words we could not prove** | `MPL-1.1` | `dropped.tsv` — **not ours to license** |
...
file a subset of that dictionary and it carries that dictionary's terms — here `MPL-1.1`.
